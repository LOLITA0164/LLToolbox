...
static LLToolbox* obj = nil;
@implementation LLToolbox
...
#pragma mark - 颜色类
@implementation LLToolbox (UIColor)
+(UIColor * _Nonnull (^)(NSInteger))colorWithHex{
    return ^UIColor* (NSInteger rgbValue) {
        return [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0];
    };
}
+(UIColor * _Nonnull (^)(CGFloat, CGFloat, CGFloat))colorWithRGB{
    return ^id(CGFloat r, CGFloat g, CGFloat b) {
        return [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:1];
    };
}
+(UIColor*)randColor{
    return LLToolbox.colorWithRGB(arc4random_uniform(255), arc4random_uniform(255), arc4random_uniform(255));
}
@end
...
@end
@implementation LLToolbox (AppInfo)
-(AppInfo*)app{
    return AppInfo.new;
}
@end
...
//}
@end
@implementation LLToolbox (Device)
/// 设置信息
-(Device*)device{
    return Device.new;
}
